...
const Creation = (props) => {
    ...
    const [category, setCategory] = useState(""); //tal vez poner seleccion multiple
            ...
            <div className="Creation_Second">
                ...
                <form onSubmit={submitHandler}  className="Creation_Form">
                    ...
                    <div>
                        ...
                        <input type="number" key="seats" onChange={seatsChangeHandler} value={seats}  className="Creation_input"></input>
                    </div>
                    <div>
                        <label htmlFor="category">Tipo de vehiculo:</label>
                        <input type="text" key="category" onChange={categoryChangeHandler} value={category}  className="Creation_input"></input>
                    </div>
                    <div>
