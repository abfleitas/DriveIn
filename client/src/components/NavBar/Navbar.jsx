      ...
      <body class="bg-blue-500">
        <nav class="relative px-4 py-4 flex justify-between items-center bg-white shadow-lg rounded-2xl">
          ...
          <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            ...
            {/* <li>
              <a class="text-sm text-gray-400 hover:text-[#2e3a46]" href="#">
                Precios
              </a>
            </li> */}
          </ul>
        ...
        <div class="navbar-menu relative z-50 hidden">
          ...
          <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            <div class="flex items-center mb-8">
              <div class="mr-auto text-3xl font-bold leading-none" href="#">
              ...
              <button class="navbar-close">
                <svg
                  class="h-6 w-6 text-gray-400 cursor-pointer hover:text-[#2e3a46]"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
            ...
            <div>
              <ul>
                <li class="mb-1">
                  <div
                    class="block p-4 text-sm font-semibold text-[#2e3a46] hover:text-[#f97d67] cursor-pointer"
                    href="#"
                  >
                    Home
                  </div>
